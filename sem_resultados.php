...
<body>
	<div class="container">
		...
		<div class="col-md-8">
			...
			<br>
			<h5 class="text-center"><strong>Não foram encontrados resultados para a pesquisa informada</strong></h5>
			<br>
			<h5 class="text-center"><strong><a href="index.php" class="text-center">Retornar</a></strong></h5>
